    ...
    <section id="home" style={{ position: 'relative', minHeight: '94vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, padding: '100px 20px 60px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto', textAlign: 'center' }}>
          ...
          {/* Toggle Date Search Widget Button */}
          <button
          ...
          >
            <Search size={14} /> {showSearchBox ? "Hide Check-in Search" : "Check Villa Staycation Rates & Availability"}
          </button>

          {/* Collapsible Date Availability Search Widget */}
          {showSearchBox && (
            <form onSubmit={handleQuickSearch} className="glass-card animate-fade-in" style={{
              padding: '24px 28px',
